...
Background: Events info in database
  ...
  | name                    | location       | interests     | budget   | frequency of entertainment |
...
Scenario 1: Click Recommend to get recommended events
  Given I am on the home page for the app
  Then I give the input parameters
  And  I click on "Recommend events" 
  Then I should see Events recommended

Scenario 2: Click Recommend to get recommended events without input
  Given I am on the home page for the app
  Then I don't give in the input for events
  And  I click on "Recommend events" 
